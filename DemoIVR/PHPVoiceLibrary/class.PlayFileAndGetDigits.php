...
class PlayFileAndGetDigits
{
  ...
  function GetResult()
  {
    ...
    { 
        ...
        return $jsonStart.$jsonAction.$jsonFile.$jsonNextUrl.$jsonResult.$jsonErrorFile.$jsonDigitTimeOut.$jsonInputTimeOut.$jsonLoops.$jsonTerminator.$jsonStrip.$jsonMaxDigits.$jsonDigits.$jsonEnd;
    }
    catch(exception $ex)
    {
        return $ex;
